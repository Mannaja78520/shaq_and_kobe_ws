...
class EVO : public MotorInterface
{
private:
    int in_a_pin_;
    int in_b_pin_;
...
public:
    EVO(float pwm_frequency, int pwm_bits, bool invert, bool brakemotortype, int pwm_pin, int in_a_pin, int in_b_pin) : MotorInterface(invert, brakemotortype),
                                                                                                                         in_a_pin_(in_a_pin),
                                                                                                                         in_b_pin_(in_b_pin),
                                                                                                                         pwm_pin_(pwm_pin)
    {
